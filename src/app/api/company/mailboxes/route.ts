...
// Lists the mailboxes of one company via POST {TRACKVID_API_URL}/system-admin/company/mailboxes. The SystemAdmin token
...
export async function POST(req: Request) {
  ...
  const res = await fetch(`${apiBase.replace(/\/$/, '')}/system-admin/company/mailboxes`, {
    method: 'POST',
    headers: {
