// Proxy for the Pending CMS "Renew" button — forwards to
// {TRACKVID_API_URL}/system-admin/meesho/renew-session, which asks
// Automated-scripts to run a fresh Puppeteer login and cache the cookie jar.
...
export async function POST(req: Request) {
  ...
  const res = await fetch(`${apiBase.replace(/\/$/, '')}/system-admin/meesho/renew-session`, {
    method: 'POST',
    headers: {
